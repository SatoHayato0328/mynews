...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="Viewport" content="wigth=device-width, initial-svale=1">
        ...
        <link href="https://fonts.googleapis.com/css?family=Ralewy:300,400,600" rel="stylesheet" type="text/css">
